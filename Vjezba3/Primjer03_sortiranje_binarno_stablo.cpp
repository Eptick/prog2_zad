...
int main(){
  ...
  do{
    indeks=0;
		...
		switch(izbor){
			case 1:
        puni_polje(polje1,broj_el);
        cout <<"Ispunjeno!"<<endl;break;
			case 2:
        puni(stablo,polje1,broj_el);
        cout <<"Upisano u stablo!"<<endl;break;
			case 3:
        sort(stablo,polje2);break;
			case 4:
        sort(stablo,polje2,2);break;
			case 5:
        ispis(polje2,broj_el);
        cout << endl;break;
		};
  } while(izbor!=9);
    dealokacija (stablo);
