...
telement *T_43284(telement *stablo, int broj=100){//vraæa adresu èvora ili NULL
...
int main(){
  ...
  do{
    ...
    switch (izbor){
      ...
      case 3: cout << "Kljuc = ";
              cin >> kljuc;
              if(T_43284(stablo,kljuc))
                cout << "Kljuc je nadjen na adresi " << (int)(size_t)T_43284(stablo,kljuc) << endl;
              else
                cout << "Kljuc nije nadjen u stablu!" << endl;
              ;break;
      case 9: break;
    }//switch
  } while(izbor!=9);
